...
export default function PostItem() {
  ...
  const addItem = useDbStore((s) => s.addItem);
  ...
  const initialValues: PostItemFormValues = {
    title: "", category: "", description: "", location: "", date: "", reward: false,
  };
  ...
  const handleSubmit = async (values: PostItemFormValues) => {
    ...
    addItem({
      ...
      type: itemType,
      status: "active",
      images: images.length > 0 ? images : ["https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=400"],
      location: values.location,
      date: values.date,
      userId: user.id,
      user: user,
      reward: itemType === "lost" ? values.reward : undefined,
    });
              ...
              {({ errors, touched, isSubmitting, values, setFieldValue }) => (
                <Form className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <Field as={Input} id="title" name="title" placeholder="e.g., iPhone 14 Pro, Black Backpack"
                  ...
                  <div className="space-y-2">
                    ...
                    <Field as={Textarea} id="description" name="description"
                      placeholder="Describe the item in detail..." rows={4}
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={values.location} onValueChange={(value) => setFieldValue("location", value)}>
                      <SelectTrigger className={errors.location && touched.location ? "border-destructive" : ""}>
                  ...
                  <div className="space-y-2">
                    ...
                    <Field as={Input} id="date" name="date" type="date" max={new Date().toISOString().split("T")[0]}
                  ...
                  {itemType === "lost" && (
                    <div className="flex items-center space-x-2">
                      <Checkbox id="reward" checked={values.reward}
                        onCheckedChange={(checked) => setFieldValue("reward", checked as boolean)} />
                  ...
                  <Button type="submit" className="w-full" size="lg" disabled={isSubmitting}>
                    {isSubmitting ? (<><Loader2 className="h-4 w-4 mr-2 animate-spin" />Posting...</>) :
